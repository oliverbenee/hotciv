...
public class AlphaCivMapStrategy implements MapStrategy {
  public void createWorld(GameImpl game){
    ...
    game.createUnit(new Position(2,0), new UnitImpl(Player.RED, GameConstants.ARCHER, 1, 3, 2));
    game.createUnit(new Position(3,2), new UnitImpl(Player.BLUE, GameConstants.LEGION, 1, 3, 4));
    game.createUnit(new Position(4,3), new UnitImpl(Player.RED, GameConstants.SETTLER , 1, 2,0));
  }
}
